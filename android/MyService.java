...
public class MyService extends Service {
    ...
    public void onCreate() {
        ...
        ConnectThread thread = new ConnectThread("192.168.216.22");
        thread.start();
    }
        ...
        public void run(){
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read.substring(0, 2).equals("현재")) {
                        Intent showIntent = new Intent(getApplicationContext(), ReturnActivity.class);
                        showIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        showIntent.putExtra("step", 3);
                        showIntent.putExtra("data", read);
                        startActivity(showIntent);
                    } else if (read.substring(0, 2).equals("정보")) {
                        Intent showIntent = new Intent(getApplicationContext(), ProgressActivity.class);
                        showIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        showIntent.putExtra("step", 3);
                        showIntent.putExtra("data", read);
                        startActivity(showIntent);
                    } else if (read.substring(0, 3).equals("로그인")) {
                        Intent showIntent = new Intent(getApplicationContext(), MainActivity.class);
                        showIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        showIntent.putExtra("step", 3);
                        showIntent.putExtra("data", read);
                        startActivity(showIntent);
                    } else if (read.substring(0, 2).equals("진도")) {
                        Intent showIntent = new Intent(getApplicationContext(), ManageActivity.class);
                        showIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        showIntent.putExtra("step", 3);
                        showIntent.putExtra("data", read);
                        startActivity(showIntent);
